...
public:
	...
	inline const std::vector<uint64_t>			&	GetThreadLocks() const
	{
...
private:
	std::vector<uint64_t>							locked_to_threads			= {};
	uint64_t										task_index					= {};
...
public:
	...
	inline uint64_t			GetThreadIndex()
	{
		return thread_index;
	}
...
public:
	...
	uint64_t											ScheduleTask(
		...
		const std::vector<uint64_t>					&	locked_to_threads			= {},
