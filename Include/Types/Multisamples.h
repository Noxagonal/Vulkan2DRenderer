...
/// @brief		Multisample flags. Single variable can contain multible multisample flags.
...
/// @brief		Operator & for multisamples, this can be used to test if a multisample variable
///				contains a specific multisample flag. For example:
/// @code
...
/// @brief		Operator | for multisamples, this can be used to set a multisample flag on a
///				variable without disturbing other multisample flags in the variable.
///				For example:
/// @code
