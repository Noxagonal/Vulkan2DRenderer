...
public:
	...
	std::atomic_size_t							failed_tasks				= {};
...
enum class TaskInvokeResult
{
	...
	/// @brief		Task is rescheduled for later.
	RESCHEDULE,
};
...
public:
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	virtual TaskInvokeResult					operator()(
...
public:
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	inline										LocalThreadData()
	{};

	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	inline										LocalThreadData(
		const LocalThreadData				&	other
	) = delete;

	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	inline										LocalThreadData(
		LocalThreadData						&&	other
	) = default;

	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	inline virtual								~LocalThreadData()
	{};
...
private:
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	std::atomic_uint64_t								task_index_counter			= {};
	std::unique_ptr<SharedThreadData>					thread_shared_resource		= {};
	std::vector<std::unique_ptr<LocalThreadData>>		thread_private_resources	= {};
